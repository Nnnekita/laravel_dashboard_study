                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" value="{{ old('title') }}" class="mt-1 block w-full" />
                        ...
                        <div>
                            ...
                            <textarea id="short_description" name="short_description" rows="2"
                                      class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('short_description') }}</textarea>
                        </div>

                        <div>
                            <x-input-label for="full_description" value="Полное описание" />
                            <textarea id="full_description" name="full_description" rows="6"
                                      class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('full_description') }}</textarea>
                        </div>
